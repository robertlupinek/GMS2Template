...
if ( assign_input() ){
	if ( global.game_type == "shooter" ){
		var new_player = instance_create_layer(obj_camera.x,obj_camera.y,"Instances",obj_s_player);	
	}
	if ( global.game_type == "platformer" ){
		var new_player = instance_create_layer(obj_camera.x,obj_camera.y,"Instances",obj_p_player);	
	}
